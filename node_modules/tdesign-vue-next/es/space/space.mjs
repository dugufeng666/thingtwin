...
import { defineComponent, computed, isVNode, Teleport, createVNode, Fragment } from 'vue';
import props from './props.mjs';
import { usePrefixClass } from '../hooks/useConfig.mjs';
import { u as useTNodeJSX } from '../_chunks/dep-8664c288.mjs';
import { useChildSlots, useFlatChildrenSlots } from '../hooks/slot.mjs';
import { isArray, isNumber, isString } from 'lodash-es';
import { g as getFlexGapPolyFill } from '../_chunks/dep-b638a875.mjs';
  ...
  setup: function setup(props2) {
    ...
    function renderChildren() {
      ...
      return children.map(function (child, index) {
        var isTeleport = isVNode(child) && child.type === Teleport;
