...
import { defineComponent, toRefs, createVNode, provide, reactive, computed, mergeProps } from 'vue';
...
var _Breadcrumb = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var ellipsisContent = computed(function () {
      var items = breadcrumbOptions.value;
      var ellipsisItems = items.slice(props2.itemsBeforeCollapse, items.length - props2.itemsAfterCollapse);
      ...
      return ellipsisSlot || createVNode(EllipsisIcon$1, null, null);
    });
