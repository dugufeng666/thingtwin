...
import props from './chat-item-props.mjs';
import { isString, isObject } from 'lodash-es';
import { Skeleton } from '../skeleton/index.mjs';
import { u as useTNodeJSX } from '../_chunks/dep-8543d432.mjs';
import _ChatContent from './chat-content.mjs';
import { CheckCircleIcon } from 'tdesign-icons-vue-next';
import _ChatLoading from './chat-loading.mjs';
import _ChatReasoning from './chat-reasoning.mjs';
...
var _ChatItem = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    return function () {
      ...
      }, [isObject(props2.reasoning) && createVNode(_ChatReasoning, {
        "role": role.value,
      ...
      }, null), isString(props2.reasoning) && createVNode(_ChatReasoning, {
        "role": role.value,
