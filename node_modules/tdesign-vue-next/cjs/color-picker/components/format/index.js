...
var constants = require('../../../_chunks/dep-8fb19e2b.js');
...
var _createCompounder = require('../../../_chunks/dep-0b6e5f33.js');
 ...
 * // => 'FOO BAR'
 */
var upperCase = _createCompounder.createCompounder(function (result, word, index) {
...
var FormatPanel = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    return function () {
      ...
      }, _isSlot(_slot = constants.FORMATS.map(function (item) {
        return Vue.createVNode(select_index.Option, {
          "key": item,
          "value": item,
          "label": upperCase$1(item),
          "style": {
            fontSize: "12px"
          }
        }, null);
