...
var chat_chatLoadingProps = require('./chat-loading-props.js');
...
var _ChatLoading = Vue.defineComponent({
  name: "TChatLoading",
  props: chat_chatLoadingProps["default"],
  setup: function setup(props2) {
    var componentName = hooks_useConfig.usePrefixClass("chat-loading");
    return function () {
      return Vue.createVNode("div", {
        "class": "".concat(componentName.value)
      }, [props2.animation === "moving" ? Vue.createVNode("div", {
